...
def train(args, split, save_path):
    ...
    for epoch in range(args.max_epoch):
        ...
        val_fscore, diversity = evaluate(model, val_loader, args.nms_thresh, args.device)
        ...
        cls_loss_list.append(stats.cls_loss)
        loc_loss_list.append(stats.loc_loss)
        diversity_list.append(diversity)
        fscore_list.append(val_fscore)

    res_dict = {'loss':loss_list,'cls_loss':cls_loss_list, 'loc_loss':loc_loss_list, 'diversity':diversity_list, 'fscore': fscore_list}
    
    return max_val_fscore, res_dict
